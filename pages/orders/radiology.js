...
import { FaPlus, FaXRay, FaEye, FaExclamationTriangle } from "react-icons/fa";
import { format } from "date-fns";

function RadiologyOrdersPage() {
  ...
  if (error) {
    return (
      <Layout>
        <div className="text-red-600">Failed to load radiology orders</div>
      </Layout>
    );
  }
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center">
              <FaXRay className="mr-3 text-yellow-600" />
              Radiology Orders
            </h1>
            <p className="text-gray-600 mt-1">
              Manage radiology imaging orders and reports
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="card">
            <p className="text-sm text-gray-600 mb-1">Critical Findings</p>
        ...
        <div className="card">
          {!ordersData ? (
            <div className="text-center py-12">
              ...
              <p className="mt-4 text-gray-600">Loading radiology orders...</p>
            </div>
          ) : orders.length === 0 ? (
            <div className="text-center py-12">
              <FaXRay className="text-6xl text-gray-300 mx-auto mb-4" />
              <p className="text-gray-600">No radiology orders found</p>
              <p className="text-sm text-gray-500 mt-2">
                Try adjusting your filters or create a new radiology order
              </p>
            </div>
          ) : (
            <>
              ...
              <div className="mt-6 flex items-center justify-between border-t pt-6">
                <div className="text-sm text-gray-600">
                  ...
                  of {pagination.total} radiology orders
                </div>
                <div className="flex space-x-2">
                  <button
...
export default withAuth(RadiologyOrdersPage);
